...
extern "C" void get_position(void* ptr, float* pOutX, float* pOutY, float* pOutZ, size_t size);

extern "C" void get_normal(void* ptr, float* pOutX, float* pOutY, float* pOutZ, size_t index);
